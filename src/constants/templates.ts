...
export const imageTemplates: ImageTemplate[] = [
  {
    key: 'rcp-ubuntu-2204',
    label: 'Ubuntu 22.04',
    id: 'd9f44127-1761-448d-8077-788128f4f0b5',
    description: '웹·앱 서버, 개발 환경, ML 등 범용 워크로드에 추천',
  },
  {
    key: 'rocky-9',
    label: 'Rocky Linux 9',
...
export const networkTemplates: NetworkTemplate[] = [
  {
    key: 'demo-net',
    label: 'demo-net',
    id: '5daf4369-9bd9-4dd8-b9da-f2b73ea7dbdb',
    description: 'VM 생성 검증이 완료된 기본 네트워크',
  },
  {
    key: 'public1',
    label: 'public1',
    id: 'b1d9feee-0039-4f0c-9c3e-39947b11a23b',
    description: 'OpenStack public1 네트워크',
  },
];
